Ext.define('sjy.egineering.Panel.WTContractLX', {
    //继承的panel
    ...
    constructor: function(config) {
        ...
        me.templateStore = Ext.create('Ext.data.JsonStore', {
            ...
            proxy: {
                ...
                extraParams: {
                    method: 'GetData',
                    ProcessName: '设计院-外托合同-大项目合作（小于100万）',
        ...
        me.temlateGrid = Ext.create("Ext.grid.Panel", {
            ...
            listeners: {
                ...
                rowdblclick: function(grid, record, item, rowIndex, e, eOpts) {
                    this.Zhuanf("外托合同大项目合作（小于100万）", grid);
                },
            },
            tools: [{
                type: 'refresh',
        ...
        me.btnExcelExport = Ext.create('YZSoft.src.button.ExcelExportButton', {
            grid: me.temlateGrid,
            templateExcel: YZSoft.$url(me, '外托合同-大项目合作(小于100万).xls'), //导出模板，不设置则按缺省方式导出
            params: {},
            fileName: '外托合同-大项目合作(小于100万)',
