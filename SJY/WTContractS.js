Ext.define('sjy.egineering.Panel.WTContractS', {
    //继承的panel
    ...
    constructor: function(config) {
        ...
        me.btnExcelExport = Ext.create('YZSoft.src.button.ExcelExportButton', {
            grid: me.temlateGrid,
            templateExcel: YZSoft.$url(me, '外托合同-小专业合作.xls'), //导出模板，不设置则按缺省方式导出
            params: {},
            fileName: '外托合同-小专业合作',
