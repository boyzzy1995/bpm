Ext.define('sjy.FixedAssets.Manage.Panel.Manage', {
    //继承的panel
    ...
    constructor: function(config) {
        ...
        //主表布局
        me.MainGrid = Ext.create("sjy.FixedAssets.Manage.Grid.ManageGrid", {
        ...
        me.btnExcelExport = Ext.create('YZSoft.src.button.ExcelExportButton', {
            ...
            listeners: {
                beforeload: function(params) {
                    ...
                    Ext.Ajax.request({
                        url: 'sjy/FixedAssets/Manage/StoreDataService/Manage_EvenDateInfo.ashx',
                        method: 'POST',
                        async: false,
        ...
        me.searchPanel = Ext.create('sjy.FixedAssets.Manage.Panel.SearchPanel', {
    ...
    Turn: function(grid) {
        var me = this;
        var view = YZSoft.ViewManager.addView(me, 'sjy.FixedAssets.Manage.Panel.Turn', {
            title: '更换保管人',
            closable: true,
            grid: me.MainGrid,
        });
