Ext.define('sjy.glsc.Panel.ModifyNormalSchedule', {
	//继承的panel
	...
	constructor: function(config) {
		...
		me.templateStore = Ext.create('Ext.data.JsonStore', {
			...
			proxy: {
				type: 'ajax',
				url: YZSoft.$url(me, '../StoreDataService/EventInfoData/DDMY_OfficeEventInfoData.ashx'),
				extraParams: {
					...
					ProcessName: '设计院-管理手册-设计文件校审记录流程(一般流程)',
					PostUserAccount: '',
					PostDateType: 'period',
					TaskStatus: 'all',
