Ext.define('sjy.glsc.Panel.CommunicationReport', {
    //继承的panel
    ...
    constructor: function(config) {
        ...
        me.btnExcelExport = Ext.create('YZSoft.src.button.ExcelExportButton', {
            grid: me.temlateGrid,
            templateExcel: YZSoft.$url(me, '站局领导沟通汇报表模板.xls'), //导出模板，不设置则按缺省方式导出
            params: {},
            fileName: '站局领导沟通汇报表',
...
        width: 120
        ...
        me.temlatePanel = Ext.create('Ext.panel.Panel', {
            border: false,
            layout: 'border',
            tbar:[me.btnAddProject,me.btnEditProject,,me.btnExcelExport,"开始时间:",me.ComboxstEdit,"结束时间",me.ComboxendEdit,"登记人:",me.Registrant,'事件描述', me.Search, me.btnSearch3],
