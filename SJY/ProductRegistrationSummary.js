Ext.define('sjy.glsc.Panel.ProductRegistrationSummary', {
	//继承的panel
	...
	constructor: function(config) {
		...
		me.templateStore = Ext.create('Ext.data.JsonStore', {
			...
			proxy: {
				type: 'ajax',
				url: YZSoft.$url(me, '../StoreDataService/EventInfoData/ProductRegistrantion/PRe_EventInfoData.ashx'),
				extraParams: {
					method: 'GetData',
				},
				reader: {
        ...
        //登记人
        me.Registrant = Ext.create('YZSoft.src.form.field.User', {
		...
		me.temlatePanel = Ext.create('Ext.panel.Panel', {
			border: false,
			layout: 'border',
			tbar:[me.btnEditProject,"年份查找:",me.ComboxsjEdit,"登记人:",me.Registrant,"阶段:",me.Stage,'事件描述', me.Search, me.btnSearch3],
