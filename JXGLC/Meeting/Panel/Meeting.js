Ext.define('JXGLC.Meeting.Panel.Meeting', {
    //继承的panel
    ...
    constructor: function(config) {
        ...
        me.templateStore = Ext.create('Ext.data.JsonStore', {
            ...
            proxy: {
                type: 'ajax',
                url: YZSoft.$url(me, '../StoreDataService/WBMeeting.ashx'),
                extraParams: {
        ...
        me.temlatePanel = Ext.create('Ext.panel.Panel', {
            ...
            tbar: [me.btnAddMainContract,"年份查找：", me.ComboxsjEdit, '事件描述', me.Search, me.btnSearch3],
    ...
    addNew: function() {
        YZSoft.BPM.src.ux.FormManager.openPostWindow('嘉兴管理处-外部会议', {
            title: '添加外部会议 - ',
            dlgModel: 'Dialog', //Tab,Window,Dialog
            width: 1000,
            height: 600,
